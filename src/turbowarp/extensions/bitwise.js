...
/* generated l10n code */Scratch.translate.setup({"de":{"_Bitwise":"Bitweise"},"fi":{"_Bitwise":"Bittimenetelmät"},"it":{"_Bitwise":"Operazioni su Bit"},"nb":{"_Bitwise":"Bitvis"},"nl":{"_Bitwise":"Bitsgewijs","_[CENTRAL] to binary":"[CENTRAL] naar binair","_[CENTRAL] to number":"[CENTRAL] naar decimaal","_[LEFT] and [RIGHT]":"[LEFT] en [RIGHT]","_[LEFT] or [RIGHT]":"[LEFT] of [RIGHT]","_[LEFT] xor [RIGHT]":"[LEFT] xof [RIGHT]","_is [CENTRAL] binary?":"is [CENTRAL] binair?","_not [CENTRAL]":"niet [CENTRAL]"},"ru":{"_Bitwise":"Пробитие","_[CENTRAL] to binary":"[CENTRAL] в двоичный","_[CENTRAL] to number":"[CENTRAL] в цифру","_[LEFT] and [RIGHT]":"[LEFT] и [RIGHT]","_[LEFT] or [RIGHT]":"[LEFT] или [RIGHT]","_[LEFT] xor [RIGHT]":"[LEFT] исключающее или [RIGHT]","_is [CENTRAL] binary?":"[CENTRAL] двоичный?","_not [CENTRAL]":"не [CENTRAL]"},"zh-cn":{"_Bitwise":"位运算","_[CENTRAL] to binary":"转换数字[CENTRAL]为二进制","_[CENTRAL] to number":"转换二进制[CENTRAL]为数字","_is [CENTRAL] binary?":"[CENTRAL]是二进制？"}});/* end generated l10n code */((Scratch) => {
  "use strict";
