...
/* generated l10n code */Scratch.translate.setup({"de":{"_Couplers":"Coupler"},"fi":{"_Couplers":"Kytkimet"},"it":{"_Couplers":"Adattatori"},"ja":{"_Couplers":"カプラ"},"nb":{"_Couplers":"Koblinger","_angle [ANGLE]":"vinkel [ANGLE]","_color [COLOUR]":"farge [COLOUR]","_matrix [MATRIX]":"matrise [MATRIX]","_note [NOTE]":"notat [NOTE]","_true":"sann"},"nl":{"_Couplers":"Koppelingen","_angle [ANGLE]":"richting [ANGLE]","_color [COLOUR]":"kleur [COLOUR]","_false":"onwaar","_note [NOTE]":"toon [NOTE]","_true":"waar"},"ru":{"_Couplers":"Муфта","_angle [ANGLE]":"угол [ANGLE]","_color [COLOUR]":"цвет [COLOUR]","_false":"нет","_matrix [MATRIX]":"матрица [MATRIX]","_note [NOTE]":"нота [NOTE]","_true":"да"},"zh-cn":{"_Couplers":"耦合器","_angle [ANGLE]":"角度[ANGLE]","_color [COLOUR]":"颜色[COLOUR]","_false":"假","_matrix [MATRIX]":"矩阵[MATRIX]","_note [NOTE]":"音符[NOTE]","_true":"真"}});/* end generated l10n code */((Scratch) => {
  "use strict";
