...
/* generated l10n code */Scratch.translate.setup({"de":{"_Base":"Basis"},"fi":{"_Base":"Kantaluvut"},"it":{"_Base":"Basi"},"ja":{"_Base":"進数","_[A] from base [B] to base [C]":"[B]進数の数[A]を[C]進数に変換する","_is base [B] [A]?":"[A]は[B]進数で表現できる"},"nb":{"_[A] from base [B] to base [C]":"[A] fra base [B] til base [C]","_is base [B] [A]?":"er base [B] [A]?"},"nl":{"_[A] from base [B] to base [C]":"zet [A] om van base-[B] naar base-[C]","_is base [B] [A]?":"is [A] base-[B]?"},"ru":{"_Base":"База","_[A] from base [B] to base [C]":"[A] из базы [B] в базу [C]","_is base [B] [A]?":"база [B] [A]?"},"zh-cn":{"_Base":"进制转换","_[A] from base [B] to base [C]":"把[B]进制的[A]转换成[C]","_is base [B] [A]?":"[A]是[B]进制吗？"}});/* end generated l10n code */((Scratch) => {
  "use strict";
